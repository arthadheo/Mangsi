...
class Auth extends CI_Controller
{
    ...
    public function signing_up()
    {
        ...
        else
        {
            ...
            $this->session->set_flashdata('message','<div class="alert alert-success" role="alert">
            Account has successfully been made.
            </div>');
            redirect(base_url("login"));
        }
        }
    ...
    private function sendEmail($token, $type)
    {
        ...
        $config = [
            ...
            'smtp_user' => '35406d92340203',
            'smtp_pass' => 'aba35e8aff3778',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        if($type == 'verify')
        {
            $this->email->subject('Account Verfication');
    ...
    public function verify()
    {
        ...
        $pelanggan = $this->get_by_atr('pelanggan', array('email'=>$email))->row_array();

        if($pelanggan)
        {
            $token_pelanggan = $this->get_by_atr('pelanggan', array('email'=>$email))->row_array();
        }
        // belum selesai
    }
